...
\$$$$$$\  $$ /  $$ |$$ |$$ |      $$ |  $$ |$$ /  $$ |$$ |$$ |  $$$$$$$$ | $$$$ _/ \__|
 \____$$\ $$ |  $$ |$$ |$$ |      $$ |  $$ |$$ |  $$ |$$ |$$ |  $$   ____|$$  _/       
$$$$$$$  |\$$$$$$$ |$$ |$$ |      $$ |  $$ |\$$$$$$  |$$ |$$ |$$\$$$$$$$\$$$$$$$$\ $$\ 
\_______/  \____$$ |\__|\__|      \__|  \__| \______/ \__|\__|\__\_______\________|\__|
                $$ |                                                                   
                $$ |                                                                   
                \__|                                                                   
...
#Hati hati coy kalo mau ngubah query perhatikan variabel nya
...
▒${N}█▐${R}▒▒▒${N}████████████${R}▒▒▒▒       ${P}  Dr.Dork${R}
▒${N}▌▐${R}▒▒${N}██▄▀██████▀▄██${R}▒▒▒  ${N} ⊱⋅ ──────────── ⋅⊰⊱${N}⋅
${N}▐┼▐${R}▒▒${N}██▄▄▄▄██▄▄▄▄██${R}▒▒▒   ${BL}Author: ${BR}./holl.ez${N} 
${N}▐┼▐${R}▒▒${N}██████████████${R}▒▒▒      ${P}psqliholl.ez
${N}▐▄▐████─▀▐▐▀█─█─▌▐██▄${R}▒
▒▒${N}█████──────────▐███${R}▌ ${N}❏ ❐ ❑ ❒ ❏ ❐ ❏ ❐ ❑ ❒ ❏ ❐${R}
...
${G}█████████
${G}█▄█████▄█ 
${G}█▼▼▼▼▼     ${U}Author ${N}by ${R}holl.ez
${G}█          ${BL}pwnd ./psqli holl.ez 
${G}█▲▲▲▲▲     
${G}█████████
${G}__██____██___
 ...
 2) masn="y"
  ...
  5) masn="n"
   ...
   6) clear
     ...
     echo -e "[${G}1${N}]. inject biasa cuy"
     echo -e "[${G}2${N}]. inject masal cuy"
     echo -e "[${G}3${N}]. balik ke menu utama"
     echo -ne "[${R}?${N}] pilih mana ?? "
     read d
     case $d in
      1) masn="n"
        waff="n"
   ...
   7) clear
     ...
     echo -e "[${G}1${N}]. scan biasa cuy"
     echo -e "[${G}2${N}]. scan masal cuy"
     echo -e "[${G}3${N}]. balik ke menu utama"
     echo -ne "[${R}?${N}] pilih mana ?? "
     read d
     case $d in
